...
- Source code: Licensed under GPLv3.  For the full text, see [[https://spdx.org/licenses/GPL-3.0-only.html][GPLv3]]
- Data derived from the symbolizations on Wikipedia, including the
  Anki Deck: Licensed under CC-BY-NC-ND-4.0.  For the full text, see
